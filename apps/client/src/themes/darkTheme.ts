	...
	layers: [
		{
			button: {
				...
				pressed: { fillColor: black, borderColor: orange, textColor: white },
			...
			background: '#121212',
			formElements: {
				...defaultTheme.layers[0].formElements,
				inputField: {
					...defaultTheme.layers[0].formElements?.inputField,
				...
				checkbox: {
					...defaultTheme.layers[0].formElements?.checkbox,
					default: { fillColor: deepBlue, borderColor: lightBlue, textColor: white },
					disabled: { fillColor: darkGrey, borderColor: lightGrey, textColor: lightGrey },
				},
				radioButton: {
					...defaultTheme.layers[0].formElements?.radioButton,
					default: { fillColor: deepBlue, borderColor: lightBlue, textColor: white },
					disabled: { fillColor: darkGrey, borderColor: lightGrey, textColor: lightGrey },
				},
				dropDownMenu: {
					...defaultTheme.layers[0].formElements?.dropDownMenu,
					default: { fillColor: deepBlue, borderColor: lightBlue, textColor: white },
					disabled: { fillColor: darkGrey, borderColor: lightGrey, textColor: lightGrey },
				},
			},
